...
<!-- Портфолио: раскрывается список проектов, а каждый проект раскрывается отдельно -->
...
<!-- Таблица: слева текст, справа скриншоты -->
<table>
  <tr>
  ...
  <!-- ✅ ШАБЛОН для следующих проектов (скопируй и заполни) -->
  <details>
    <summary><h2>🧩 Название следующего проекта</h2></summary>
    <table>
      <tr>
        <td valign="top" width="55%">
          <h3>О проекте</h3>
          ...
          <h3>🧠 Практический опыт и развитие</h3>
          <p>Что сделал, чему научился, как развиваешь…</p>
        </td>
        <td valign="top" width="45%">
          <h3>Скриншоты</h3>
          <p>
            <img src="screenshots/project2_1.png" alt="Screenshot 1" width="100%"><br><br>
            <img src="screenshots/project2_2.png" alt="Screenshot 2" width="100%">
          </p>
        </td>
      </tr>
    </table>
